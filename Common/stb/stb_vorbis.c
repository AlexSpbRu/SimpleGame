...
//#undef realloc
//#undef free
//void * __cdecl nedmalloc(size_t size);
//void * __cdecl nedcalloc(size_t no,size_t size);
//void * __cdecl nedrealloc(void *mem,size_t size);
//void  __cdecl nedfree(void *mem) ;
